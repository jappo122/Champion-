const courses = [
  // ===== Course 1: 10 Steps to the Sale (Part 1 - Descriptions) =====
  {
    ...
    description: "An in-depth exploration of the complete 10-step automotive sales process. Each lesson includes detailed explanations, key principles, common mistakes, and pro tips. Perfect for new and experienced salespeople alike. Read through each step and mark it complete as you go.",
    levels: "Beginner",
    duration: "3 hours",
    lessons: 10,
    image: "foundations",
...
- Use a handwritten note for the first follow-up — it's rare and memorable in a digital world`
  ...
  // ===== Course 2: 10 Steps of the Sale Part 2 (Quiz) =====
  {
    ...
    description: "Put your knowledge to the test with 40 scenario-based quiz questions covering every step of the 10-step automotive sales process. Each lesson contains 4 multiple-choice questions with instant feedback and detailed explanations. No reading required — just jump in and test yourself.",
    levels: "Beginner",
    duration: "1.5 hours",
    lessons: 10,
    image: "drills",
...
`
  ...
  // ===== Course 3: Advanced Closing (expanded with MCQs) =====
  {
    ...
    description: "Advanced techniques for experienced sales professionals. Each module includes in-depth strategy breakdowns, real-world applications, and 5 multiple-choice quiz questions. Master negotiation, handle multiple decision makers, and build a referral network that drives consistent sales.",
    levels: "Advanced",
    duration: "3 hours",
    lessons: 5,
    image: "closing",
...
5. B — The ethical close is the natural conclusion of serving the customer's needs well.`
  ...
  // ===== Course 3b: Advanced Closing Part 2 (Plus-gated) =====
  {
    ...
    description: "Master modern consultative closing techniques for today's informed buyers. 4 lessons covering Alternative Choice Close, Assumptive Trial Close, Either/Or Objection Handling, and Micro-Agreements. 7 MCQs per lesson.",
    levels: "Advanced",
    duration: "2 hours",
    lessons: 4,
    image: "closing",
  ...
  // ===== Course 4: Digital Marketing (expanded with MCQs) =====
  {
    ...
    description: "Learn how to use digital marketing to attract more customers to your dealership. Each 5-minute module includes detailed strategies and 5 multiple-choice quiz questions. Covers social media, email campaigns, direct mail, and marketing analytics.",
    levels: "Intermediate",
    duration: "2.5 hours",
    lessons: 4,
    image: "marketing",
...
5. C — Weekly reviews catch trends early and enable quick optimization.`
  ...
  // ===== Course 5: Customer Experience (expanded with MCQs) =====
  {
    ...
    description: "Learn how to deliver exceptional customer experiences that drive satisfaction, positive reviews, and repeat business. Each module includes in-depth strategies, real-world applications, and 5 multiple-choice quiz questions.",
    levels: "Intermediate",
    duration: "2 hours",
    lessons: 4,
    image: "experience",
...
5. B — Direct access builds lasting trust and shows you stand behind your work.`
  ...
  // ===== Course 6: Sales Drills (expanded with 5 MCQs per lesson) =====
  {
    ...
    description: "Bite-sized 5-minute training modules covering each step of the automotive sales process. Each module includes detailed strategy breakdowns and 5 multiple-choice quiz questions to sharpen your skills. Perfect for daily practice.",
    levels: "Beginner",
    duration: "2 hours",
    lessons: 10,
    image: "drills",
...
5. C — A lifetime customer is worth far more than a single transaction.`
  ...
  // ===== Course 7: Senior Sales Training (Plus+ required) =====
  {
    ...
    description: "Take your sales skills to the next level with advanced negotiation tactics, enterprise deal strategies, team leadership principles, and complex deal structuring. Designed for experienced salespeople who want to become top performers and team leaders. PLUS subscription required.",
    levels: "Advanced",
    duration: "3 hours",
    lessons: 5,
    image: "advanced",
...
`
  ...
  // ===== Course 8: Closing & Overcoming Objections =====
  {
    ...
    description: "Master the art of handling objections and closing deals with confidence. Learn to overcome price objections, hesitation, spouse objections, competitor comparisons, and timing issues. 25 scenario-based questions to sharpen your skills.",
    levels: "Intermediate",
    duration: "4 hours",
    lessons: 5,
    image: "closing",
...
**(Correct: B)**`
  ...
  // ===== Course 9: Landing on the Right Vehicle - Needs Assessment Part 2 =====
  {
    ...
    description: "Go deeper than basic needs assessment. Learn to read buying signals, match lifestyle to vehicle, navigate family vs individual needs, qualify budgets with tact, and handle trade-in psychology. 25 in-depth scenario questions.",
    levels: "Intermediate",
    duration: "4 hours",
    lessons: 5,
    image: "needs",
...
**(Correct: B)**`
  ...
  // ===== Course 10: HEART Method =====
  {
    ...
    requiredTier: "plus",
    description: "Plus+ Tier Exclusive. Master the H.E.A.R.T. framework: Human Connection, Emotional Discovery, Aligned Solutions, Respectful Guidance, and Trusted Partnership. Transform transactional selling into relational advising. 6 lessons with 48 scenario-based quiz questions.",
    levels: "Intermediate",
    duration: "5 hours",
    lessons: 6,
    image: "heart",
