...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-3",title:"Step 3 Quiz: Vehicle Presentation",description:"4 questions on presenting vehicles using the FAB method.",duration:"10 min",content:`## Step 3: Vehicle Presentation — Quiz
...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-4",title:"Step 4 Quiz: Test Drive",description:"4 questions on guiding customers through an effective test drive.",duration:"10 min",content:`## Step 4: Test Drive — Quiz
...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-5",title:"Step 5 Quiz: Trade-In Appraisal",description:"4 questions on handling trade-in appraisals transparently.",duration:"10 min",content:`## Step 5: Trade-In Appraisal — Quiz
...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-6",title:"Step 6 Quiz: Price Negotiation",description:"4 questions on navigating pricing discussions effectively.",duration:"10 min",content:`## Step 6: Price Negotiation — Quiz
...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-7",title:"Step 7 Quiz: Closing the Sale",description:"4 questions on proven closing techniques.",duration:"10 min",content:`## Step 7: Closing the Sale — Quiz
...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-8",title:"Step 8 Quiz: Finance & Insurance (F&I)",description:"4 questions on presenting F&I products effectively.",duration:"10 min",content:`## Step 8: Finance & Insurance (F&I) — Quiz
...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-9",title:"Step 9 Quiz: Delivery & Handover",description:"4 questions on delivering a memorable handover experience.",duration:"10 min",content:`## Step 9: Delivery & Handover — Quiz
...
D) The weather on the day of their visit
*Answer: B — Trust and rapport built in the first moments predict purchase intent more than any other factor.*
`},{id:"quiz-step-10",title:"Step 10 Quiz: Follow-Up & Referrals",description:"4 questions on maintaining relationships and generating referrals.",duration:"10 min",content:`## Step 10: Follow-Up & Referrals — Quiz
...
5. B — Collaborative problem-solving creates win-win outcomes and repeat business.`},{id:"multi-decision-maker",title:"Handling Multiple Decision Makers",description:"Navigate sales involving spouses, partners, and family members.",duration:"10 min",content:`## Handling Multiple Decision Makers
...
5. B — Staying neutral preserves trust with both parties and enables a true win-win.`},{id:"phone-up",title:"Phone-Up and Internet Lead Closing",description:"Convert remote inquiries into showroom visits and closed deals.",duration:"10 min",content:`## Phone-Up and Internet Lead Closing
...
5. B — Alternative-choice questions assume the appointment and make timing the only decision.`},{id:"referral-networks",title:"Building a Referral Network",description:"Create a sustainable pipeline of repeat and referral business.",duration:"10 min",content:`## Building a Referral Network
...
5. B — Systematic tracking, appreciation, and consistent outreach create sustainable referral flow.`},{id:"closing-psychology",title:"The Psychology of Closing",description:"Understand the psychological triggers that lead to buying decisions.",duration:"10 min",content:`## The Psychology of Closing
...
**(Correct: B)**`},{id:"assumptive-trial",title:"The Assumptive Trial Close",description:"Test commitment right after the test drive before final negotiations.",duration:"5 min",content:`## The Assumptive Trial Close
...
D) Start over
**(Correct: C)**`},{id:"either-or-objections",title:"Either/Or Objection Handling",description:"Isolate the real objection by framing it as an either/or choice.",duration:"5 min",content:`## Either/Or Objection Handling
...
**(Correct: A)**`},{id:"micro-agreements",title:"Micro-Agreements",description:"Build toward the close with layers of small agreements throughout the sale.",duration:"5 min",content:`## Micro-Agreements
...
A) True
B) False
**(Correct: B)**`}]},{id:"digital-marketing",title:"Digital Marketing for Dealers",subtitle:"Modern marketing strategies that drive traffic",description:"Learn how to use digital marketing to attract more customers to your dealership. Each 5-minute module includes detailed strategies and 5 multiple-choice quiz questions. Covers social media, email campaigns, direct mail, and marketing analytics.",levels:"Intermediate",duration:"2.5 hours",lessons:4,image:"marketing",icon:"M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",lessonsList:[{id:"social-media",title:"Social Media for Car Dealers",description:"Use social platforms to attract and engage customers.",duration:"10 min",content:`## Social Media for Car Dealers
...
5. B — Responding within 1 hour shows customers you're attentive and professional.`},{id:"email-marketing",title:"Email Marketing Campaigns",description:"Build and nurture leads through targeted email.",duration:"10 min",content:`## Email Marketing Campaigns
...
5. B — A single clear call-to-action focuses the reader and drives the desired response.`},{id:"direct-mail",title:"Direct Mail That Works",description:"Create effective direct mail campaigns that drive showroom traffic.",duration:"10 min",content:`## Direct Mail That Works
...
5. C — Physical mail stands out because people receive far fewer pieces than digital messages.`},{id:"marketing-roi",title:"Measuring Marketing ROI",description:"Track, analyze, and optimize your marketing spend for maximum return.",duration:"10 min",content:`## Measuring Marketing ROI
...
5. C — Weekly reviews catch trends early and enable quick optimization.`}]},{id:"customer-experience",title:"Customer Experience Excellence",subtitle:"Turn every interaction into a 5-star experience",description:"Learn how to deliver exceptional customer experiences that drive satisfaction, positive reviews, and repeat business. Each module includes in-depth strategies, real-world applications, and 5 multiple-choice quiz questions.",levels:"Intermediate",duration:"2 hours",lessons:4,image:"experience",icon:"M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",lessonsList:[{id:"first-contact",title:"First Contact to First Visit",description:"Convert online inquiries into showroom visits with a world-class first impression.",duration:"10 min",content:`## First Contact to First Visit
...
5. B — Pull up the vehicle they asked about — it shows preparation and respect for their time.`},{id:"showroom-experience",title:"The Showroom Experience",description:"Create an environment that makes customers comfortable, confident, and ready to buy.",duration:"10 min",content:`## The Showroom Experience
...
5. B — The entrance zone (first 50 feet) sets the tone for the entire visit.`},{id:"online-reviews",title:"Managing Online Reviews",description:"Build a 5-star online reputation that attracts and converts customers.",duration:"10 min",content:`## Managing Online Reviews
...
5. B — QR codes eliminate friction — one scan takes them directly to the review form.`},{id:"delivery-experience",title:"The Delivery Experience",description:"Make the final delivery memorable and exciting — the start of a lifelong customer relationship.",duration:"10 min",content:`## The Delivery Experience
...
5. B — Direct access builds lasting trust and shows you stand behind your work.`}]},{id:"sales-drills",title:"5-Minute Sales Drills",subtitle:"Quick, focused modules for every step of the sale",description:"Bite-sized 5-minute training modules covering each step of the automotive sales process. Each module includes detailed strategy breakdowns and 5 multiple-choice quiz questions to sharpen your skills. Perfect for daily practice.",levels:"Beginner",duration:"2 hours",lessons:10,image:"drills",icon:"M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",lessonsList:[{id:"drill-greeting",title:"Step 1: Meet & Greet",description:"Master the 10-second first impression that sets the tone.",duration:"5 min",content:`## Step 1: Meet & Greet — 2 Minute Drill
...
5. B — "Can I help you?" triggers the automatic "just looking" shield; use an open-ended greeting instead.`},{id:"drill-qualification",title:"Step 2: Qualification",description:"Uncover the customer's true needs in 2 minutes.",duration:"5 min",content:`## Step 2: Qualification — 2 Minute Drill
...
5. B — Timeline reveals urgency and helps prioritize your sales approach.`},{id:"drill-presentation",title:"Step 3: Vehicle Presentation",description:"Connect features to customer needs with the FAB method.",duration:"5 min",content:`## Step 3: Vehicle Presentation — 2 Minute Drill
...
5. B — Benefits make features personal and emotionally compelling.`},{id:"drill-test-drive",title:"Step 4: Test Drive",description:"Guide the test drive that builds emotional ownership.",duration:"5 min",content:`## Step 4: Test Drive — 2 Minute Drill
...
5. B — The post-drive debrief surfaces concerns and builds momentum toward closing.`},{id:"drill-trade-in",title:"Step 5: Trade-In Appraisal",description:"Handle trade-in discussions transparently and professionally.",duration:"5 min",content:`## Step 5: Trade-In Appraisal — 2 Minute Drill
...
5. B — Online research gives ballpark figures; condition and local market create variance.`},{id:"drill-price",title:"Step 6: Price Presentation",description:"Present pricing that builds value and protects gross.",duration:"5 min",content:`## Step 6: Price Presentation — 2 Minute Drill
...
5. B — Price feels right when value has been clearly established first.`},{id:"drill-closing",title:"Step 7: Closing",description:"Guide customers to a confident yes.",duration:"5 min",content:`## Step 7: Closing — 2 Minute Drill
...
5. C — The close is a process that runs through the entire sale, not a one-time event.`},{id:"drill-fni",title:"Step 8: F&I Introduction",description:"Transition customers to F&I smoothly.",duration:"5 min",content:`## Step 8: F&I Introduction — 2 Minute Drill
...
5. B — Let them know you're still with them; don't abandon the customer post-handoff.`},{id:"drill-delivery",title:"Step 9: Delivery",description:"Create a memorable delivery experience.",duration:"5 min",content:`## Step 9: Delivery — 2 Minute Drill
...
5. B — Personal accessibility shows you stand behind your work and care about satisfaction.`},{id:"drill-follow-up",title:"Step 10: Follow-Up",description:"Build systematic follow-up for repeat business and referrals.",duration:"5 min",content:`## Step 10: Follow-Up — 2 Minute Drill
...
**(Correct: B)**
`},{id:"senior-enterprise",title:"Enterprise & Fleet Deals",description:"Structure multi-vehicle deals for business and fleet customers.",duration:"35 min",content:`## Enterprise & Fleet Deals
...
**(Correct: B)**
`},{id:"senior-leadership",title:"Sales Team Leadership",description:"Lead, motivate, and develop other salespeople on your team.",duration:"35 min",content:`## Sales Team Leadership
...
**(Correct: B)**
`},{id:"senior-coaching",title:"Coaching Other Salespeople",description:"Effective one-on-one coaching techniques for automotive sales.",duration:"35 min",content:`## Coaching Other Salespeople
...
**(Correct: B)**
`},{id:"senior-complex-deals",title:"Complex Deal Structuring",description:"Navigate multi-party, high-value, and time-sensitive deals.",duration:"35 min",content:`## Complex Deal Structuring
...
**(Correct: B)**`},{id:"closing-think-about-it",title:'Handling "I Need to Think About It"',description:"Turn hesitation into commitment with the right questions.",duration:"35 min",content:`## Handling "I Need to Think About It"
...
**(Correct: B)**`},{id:"closing-spouse-objections",title:"Spouse & Partner Objections",description:"Navigate dual-decision scenarios with finesse.",duration:"35 min",content:`## Spouse & Partner Objections
...
**(Correct: B)**`},{id:"closing-competitor",title:"Competitor Comparisons",description:"Win deals when customers are cross-shopping other brands.",duration:"35 min",content:`## Competitor Comparisons
...
D) "Did you buy it?"
**(Correct: B)**`},{id:"closing-timing",title:"Timing & Urgency Objections",description:"Create ethical urgency and handle timing-based stalls.",duration:"35 min",content:`## Timing & Urgency Objections
...
**(Correct: B)**`},{id:"needs2-lifestyle-matching",title:"Matching Lifestyle to Vehicle",description:"Connect vehicle features to the customer's daily life and passions.",duration:"35 min",content:`## Matching Lifestyle to Vehicle
...
**(Correct: B)**`},{id:"needs2-family-needs",title:"Family Needs vs. Individual Needs",description:"Balance multiple priorities when a vehicle serves the whole family.",duration:"35 min",content:`## Family Needs vs. Individual Needs
...
**(Correct: B)**`},{id:"needs2-budget-qualification",title:"Budget Qualification Techniques",description:"Discuss money comfortably and qualify budgets with tact.",duration:"35 min",content:`## Budget Qualification Techniques
...
**(Correct: B)**`},{id:"needs2-tradein-psychology",title:"Trade-In Psychology",description:"Understand the emotional attachment to trade-ins and use it to build trust.",duration:"35 min",content:`## Trade-In Psychology
...
**(Correct: B)**`}]},{id:"heart-method",title:"The H.E.A.R.T. Method",subtitle:"A human-centered sales system that builds trust and closes more deals — Plus+ Tier",requiredTier:"plus",description:"Plus+ Tier Exclusive. Master the H.E.A.R.T. framework: Human Connection, Emotional Discovery, Aligned Solutions, Respectful Guidance, and Trusted Partnership. Transform transactional selling into relational advising. 6 lessons with 48 scenario-based quiz questions.",levels:"Intermediate",duration:"5 hours",lessons:6,image:"heart",icon:"M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z",lessonsList:[{id:"heart-intro",title:"Introduction to the H.E.A.R.T. Method",description:"Why human-centered selling outperforms transactional tactics and how the HEART framework transforms your results.",duration:"40 min",content:`## Introduction to the H.E.A.R.T. Method
...
**(Correct: B)**`},{id:"heart-human-connection",title:"H — Hear: Active Listening",description:"Master the art of active listening — hear what customers are really saying beneath their words.",duration:"45 min",content:`## H — Hear: Active Listening
...
**(Correct: B)**`},{id:"heart-emotional-discovery",title:"E — Empathize: Understanding Customer Needs",description:"Put yourself in the customer's shoes. Uncover the real feelings, fears, and aspirations driving every purchase decision.",duration:"50 min",content:`## E — Empathize: Understanding Customer Needs
...
**(Correct: B)**`},{id:"heart-aligned-solutions",title:"A — Act: Matching Solutions to Needs",description:"Take action based on what you've learned. Match vehicles to both practical needs and emotional desires — the perfect-fit presentation.",duration:"50 min",content:`## A — Act: Matching Solutions to Needs
...
**(Correct: B)**`},{id:"heart-respectful-guidance",title:"R — Relate: Building Rapport Through Guidance",description:"Relate to customers through respectful guidance. Lead them through decisions with expertise and integrity — no pressure, no games.",duration:"50 min",content:`## R — Relate: Building Rapport Through Guidance
...
**(Correct: A)**`},{id:"heart-trusted-partnership",title:"T — Trust: Earning Long-Term Loyalty",description:"Build unshakeable trust. Become their automotive advisor for life — turning one sale into a lifetime of referrals and repeat business.",duration:"45 min",content:`## T — Trust: Earning Long-Term Loyalty
