const i={"10-step-automotive-sales-process":`# The 10-Step Automotive Sales Process: From Greeting to Closing
...
[Start your training today](/signup) — take the first step toward becoming a top performer.`,"top-7-objections-car-sales":`# Top 7 Objections in Car Sales — And Exactly How to Overcome Them
...
[Start your training](/signup) and become objection-proof.`,"reduce-dealership-sales-turnover-training":`# How Dealership Owners Can Reduce Sales Turnover with Consistent Training
...
[See our plans](/signup) and start building a team that stays.`,"handle-price-objections-car-sales":`# How to Handle Price Objections in Car Sales
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"build-customer-trust-car-salesperson":`# How to Build Customer Trust as a Car Salesperson
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"car-sales-follow-up-secret":`# Car Sales Follow-Up: The Secret to Closing More Deals
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"advanced-closing-techniques-car-sales":`# Advanced Closing Techniques: What Elite Car Salespeople Do Differently
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"dealership-sales-training-program-guide":`# Why Dealerships Need Sales Training — And How to Choose the Right Program
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"greeting-mistake-killing-car-deals":`# The Greeting Mistake That's Killing Your Car Deals
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"sales-teams-training-consistency":`# I Tracked 50 Sales Teams for a Year. The Ones That Trained Consistently Outsold Everyone.
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"5-questions-before-showing-car":`# The 5 Questions Every Salesperson Should Ask Before Showing a Car
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"i-need-to-think-about-it-response":`# "I Need to Think About It" — The Response That Works 80% of the Time
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"why-i-stopped-full-day-seminars":`# Why I Stopped Doing Full-Day Sales Seminars
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"follow-up-cadence-4-deals":`# The Follow-Up Cadence That Added 4 Deals/Month to My Team
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`,"10-years-training-car-salespeople":`# What I've Learned Training Car Salespeople for 10+ Years
...
*Champion Sales Training & Events — Master the Sales Process. Close More Deals.*`};function l(s){const t=s.split(`
`),e=[];for(const a of t){const o=a.trim();if(o)if(o.startsWith("## "))e.push({type:"heading",text:o.replace(/^##\s*/,""),level:2});else if(o.startsWith("### "))e.push({type:"subheading",text:o.replace(/^###\s*/,""),level:3});else if(o.startsWith("**")&&o.endsWith("**")&&!o.includes(`
`))e.push({type:"text",text:o.replace(/^\*\*|\*\*$/g,"")});else if(o==="---")e.push({type:"separator"});else if(o.startsWith("> "))e.push({type:"quote",text:o.replace(/^>\s*/,"")});else if(o.startsWith("- ")){const n=e[e.length-1];n&&n.type==="list"?(n.items=n.items||[],n.items.push(o.replace(/^-\s*/,""))):e.push({type:"list",items:[o.replace(/^-\s*/,"")]})}else if(/^\d+\.\s/.test(o)){const n=e[e.length-1],r=o.replace(/^\d+\.\s*/,"");n&&n.type==="list"?(n.items=n.items||[],n.items.push(r)):e.push({type:"list",items:[r]})}else e.push({type:"text",text:o})}return e}function h(s){const t=s.match(/^#\s+(.+)$/m);return t?t[1]:"Blog Post"}function u(s){const t=s.split("---");if(t.length>=3){const a=t[2].trim();return a.length>200?a.substring(0,200)+"...":a}const e=s.replace(/^#.*$/m,"").replace(/\*\*.*?\*\*/g,"").trim();return e.length>200?e.substring(0,200)+"...":e}function c(s){const t=s.match(/\*\*By.*?\|?\s*([A-Z][a-z]+ \d{4})\*\*/);return t?t[1]:"July 2026"}function d(){return Object.keys(i).map(t=>{const e=i[t];return{id:t,slug:t,title:h(e),date:c(e),excerpt:u(e),content:e,sections:l(e)}})}function p(s){const t=i[s];return t?{id:s,slug:s,title:h(t),date:c(t),excerpt:u(t),content:t,sections:l(t)}:null}export{p as a,d as g};
