const e=[{id:"10-steps-part-1",title:"10 Steps to the Sale",subtitle:"Master every step of the automotive sales process",description:"An in-depth exploration of the complete 10-step automotive sales process. Each lesson includes detailed explanations, key principles, common mistakes, and pro tips. Perfect for new and experienced salespeople alike. Read through each step and mark it complete as you go.",levels:"Beginner",duration:"3 hours",lessons:10,image:"foundations",icon:"M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4",lessonsList:[{id:"step-1-greeting",title:"Step 1: Greeting & Building Rapport",description:"Master the art of the first impression and build trust from the moment the customer arrives.",duration:"15 min",content:`## Step 1: Greeting & Building Rapport
...
- If the customer is on their phone, wait 30 seconds before approaching. It shows respect for their time`},{id:"step-2-needs-assessment",title:"Step 2: Needs Assessment",description:"Ask targeted questions to uncover the customer's needs, budget, and lifestyle requirements.",duration:"15 min",content:`## Step 2: Needs Assessment
...
- Ask "What do you love about your current vehicle?" before asking what they want to change — it reveals their priorities`},{id:"step-3-vehicle-presentation",title:"Step 3: Vehicle Presentation",description:"Present the vehicle features that match the customer's needs using the FAB method.",duration:"15 min",content:`## Step 3: Vehicle Presentation
...
- Use the "3-Feature Rule" — present only 3 features that directly address their stated needs, then stop`},{id:"step-4-test-drive",title:"Step 4: Test Drive",description:"Guide the customer through an effective test drive experience.",duration:"15 min",content:`## Step 4: Test Drive
...
- If they smile or laugh during the drive, note what caused it and reinforce it later during the numbers presentation`},{id:"step-5-trade-in",title:"Step 5: Trade-In Appraisal",description:"Assess the value of the customer's current vehicle transparently and fairly.",duration:"15 min",content:`## Step 5: Trade-In Appraisal
...
- Offer to let them get a competing offer — the confidence that you'll match or beat it builds trust`},{id:"step-6-price-negotiation",title:"Step 6: Price Negotiation",description:"Navigate pricing discussions while maintaining value and protecting gross profit.",duration:"15 min",content:`## Step 6: Price Negotiation
...
- Use the "Feel, Felt, Found" pattern: "I understand how you feel. Many customers have felt the same way. But what they found was..."`},{id:"step-7-closing",title:"Step 7: Closing the Sale",description:"Use proven closing techniques to finalize the deal with confidence.",duration:"15 min",content:`## Step 7: Closing the Sale
...
- If they say "I need to think about it," isolate the objection: "What specifically do you need to think through?"`},{id:"step-8-fni",title:"Step 8: Finance & Insurance (F&I)",description:"Present finance and insurance options to maximize value for the customer.",duration:"15 min",content:`## Step 8: Finance & Insurance (F&I)
...
- Share a real customer story where a protection product saved them money — stories are more persuasive than statistics`},{id:"step-9-delivery",title:"Step 9: Delivery & Handover",description:"Ensure a smooth vehicle delivery that delights the customer.",duration:"15 min",content:`## Step 9: Delivery & Handover
...
- Record a short video walkthrough of the key features and text it to them — they'll refer back to it later`},{id:"step-10-follow-up",title:"Step 10: Follow-Up & Referrals",description:"Maintain the relationship and generate repeat business.",duration:"15 min",content:`## Step 10: Follow-Up & Referrals
...
- Use a handwritten note for the first follow-up — it's rare and memorable in a digital world`}]},{id:"10-steps-part-2",title:"10 Steps of the Sale Part 2",subtitle:"Test your knowledge with scenario-based quiz questions",description:"Put your knowledge to the test with 40 scenario-based quiz questions covering every step of the 10-step automotive sales process. Each lesson contains 4 multiple-choice questions with instant feedback and detailed explanations. No reading required — just jump in and test yourself.",levels:"Beginner",duration:"1.5 hours",lessons:10,image:"drills",icon:"M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",lessonsList:[{id:"quiz-step-1",title:"Step 1 Quiz: Greeting & Building Rapport",description:"4 questions on building trust and making a great first impression.",duration:"10 min",content:`## Step 1: Greeting & Building Rapport — Quiz
...
*Answer: C — A genuine smile, eye contact, and finding common ground makes customers feel welcomed. Rushing to qualify or leaving them alone both miss the opportunity to build rapport.*`},{id:"quiz-step-2",title:"Step 2 Quiz: Needs Assessment",description:"4 questions on qualifying customers and uncovering their needs.",duration:"10 min",content:`## Step 2: Needs Assessment — Quiz
...
*Answer: B — Acknowledge their statement and keep the conversation going with a gentle, open-ended question. "I'm just looking" is often a defense mechanism, not a rejection.*`},{id:"quiz-step-3",title:"Step 3 Quiz: Vehicle Presentation",description:"4 questions on presenting vehicles using the FAB method.",duration:"10 min",content:`## Step 3: Vehicle Presentation — Quiz
...
*Answer: B — Every feature you highlight should connect directly back to something the customer told you during the needs assessment. This shows you were listening and that the vehicle is the right fit.*`},{id:"quiz-step-4",title:"Step 4 Quiz: Test Drive",description:"4 questions on guiding customers through an effective test drive.",duration:"10 min",content:`## Step 4: Test Drive — Quiz
...
*Answer: B — Ask "How did that feel?" This focuses on the emotional experience rather than a logical evaluation. "What do you think?" invites criticism, while "How did that feel?" reinforces the positive experience.*`},{id:"quiz-step-5",title:"Step 5 Quiz: Trade-In Appraisal",description:"4 questions on handling trade-in appraisals transparently.",duration:"10 min",content:`## Step 5: Trade-In Appraisal — Quiz
...
*Answer: C — Offering to let them get a competing offer shows confidence in your valuation and builds trust. If they find a better offer, you can match or beat it.*`},{id:"quiz-step-6",title:"Step 6 Quiz: Price Negotiation",description:"4 questions on navigating pricing discussions effectively.",duration:"10 min",content:`## Step 6: Price Negotiation — Quiz
...
*Answer: B — Dropping price immediately without understanding the objection devalues the vehicle and trains the customer to push harder. Always understand the objection first, then respond.*`},{id:"quiz-step-7",title:"Step 7 Quiz: Closing the Sale",description:"4 questions on proven closing techniques.",duration:"10 min",content:`## Step 7: Closing the Sale — Quiz
...
*Answer: A — The alternative close gives the customer a choice between two positive options: "Would you like the red or the blue?" Either choice leads to a sale.*`},{id:"quiz-step-8",title:"Step 8 Quiz: Finance & Insurance (F&I)",description:"4 questions on presenting F&I products effectively.",duration:"10 min",content:`## Step 8: Finance & Insurance (F&I) — Quiz
...
*Answer: B — Reframe the value and share a customer story. Real stories about how protection products saved customers money are more persuasive than feature lists.*`},{id:"quiz-step-9",title:"Step 9 Quiz: Delivery & Handover",description:"4 questions on delivering a memorable handover experience.",duration:"10 min",content:`## Step 9: Delivery & Handover — Quiz
...
*Answer: B — Walk through key features one at a time. Too much information at once is overwhelming. Focus on the features they'll use most often.*`},{id:"quiz-step-10",title:"Step 10 Quiz: Follow-Up & Referrals",description:"4 questions on maintaining relationships and generating referrals.",duration:"10 min",content:`## Step 10: Follow-Up & Referrals — Quiz
...
*Answer: B — Every contact must add value. Never "just checking in" — that's a waste of their time and yours. Share useful information, a maintenance tip, or a new inventory alert.*`}]},{id:"advanced-closing",title:"Advanced Closing Strategies",subtitle:"Take your closing rate to the next level",description:"Advanced techniques for experienced sales professionals. 5-minute modules with multiple choice questions to test your knowledge. Master negotiation, handle multiple decision makers, and build a referral network that drives consistent sales.",levels:"Advanced",duration:"3 hours",lessons:5,image:"closing",icon:"M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",lessonsList:[{id:"negotiation",title:"Negotiation Mastery",description:"Learn advanced negotiation tactics to maximize deal value.",duration:"5 min",content:`## Negotiation Mastery
Advanced negotiation is about creating win-win outcomes.
### Key Principles
...
**Q1:** What should you know before starting any negotiation?

A) The customer's credit score
B) Your walk-away point
C) The competitor's lowest price
D) The manager's availability

*Answer: B) — Knowing your walk-away point prevents you from making a deal that hurts the dealership.

**Q2:** In win-win negotiation, you should focus on:

A) Price only
B) Value, not just price
C) Beating the customer
D) Getting the highest commission

*Answer: B) — Focusing on value keeps the conversation productive and relationship-oriented.

**Q3:** What is one of the most powerful tools in negotiation?

A) Talking faster
B) Silence
C) Walking away immediately
D) Offering discounts upfront

*Answer: B) — Silence creates space for the customer to fill, often revealing their true position.

**Q4:** When trading concessions, you should:

A) Give them away freely
B) Never make any concessions
C) Trade them — never give them away
D) Only make concessions after the sale

*Answer: C) — Every concession should cost the customer something in return, maintaining balance.

**Q5:** Which negotiation tactic builds the most trust?
A) Starting with an unrealistically high price
B) Being transparent about pricing while emphasizing vehicle value
C) Refusing to negotiate at all
D) Matching any competitor's price sight unseen
*Answer: B) — Transparency coupled with value emphasis creates trust while protecting margins.`},{id:"multiple-decision",title:"Multiple Decision Makers",description:"Navigate complex sales with multiple stakeholders.",duration:"5 min",content:`## Multiple Decision Makers
When more than one person is involved, adapt your approach.
### Strategies
- Identify the primary decision maker
- Address each person's concerns individually
- Create a unified vision of value

### Quick Quiz

**Q1:** When selling to multiple decision makers, your first priority should be:

A) Ignoring everyone except the loudest person
B) Identifying the primary decision maker
C) Making the sale as fast as possible
D) Offering a group discount

*Answer: B) — Knowing who makes the final call shapes your entire approach.

**Q2:** How should you handle each person's concerns?

A) Ignore them and focus on the buyer
B) Address each person's concerns individually
C) Tell them their concerns don't matter
D) Only address the primary decision maker

*Answer: B) — Each stakeholder needs to feel heard for the group to reach consensus.

**Q3:** What should you create for the group?

A) Conflict between members
B) A unified vision of value
C) Separate sales pitches for each person
D) An adversarial negotiation

*Answer: B) — A shared understanding of the vehicle's value helps the group move forward together.

**Q4:** If a spouse disagrees with the primary decision maker, you should:

A) Take the primary decision maker's side
B) Ask clarifying questions to understand both perspectives
C) Ignore the disagreement
D) End the interaction

*Answer: B) — Understanding both perspectives helps you bridge the gap and find common ground.

**Q5:** When presenting to a group that includes a silent decision maker, you should:
A) Ignore the quiet person and focus on the talkative ones
B) Directly invite the quiet person to share their thoughts
C) Assume they agree since they are not objecting
D) Ask the group to have the quiet person leave
*Answer: B) — Silent stakeholders often hold the real decision power; inviting their input prevents surprises later.`},{id:"tough-objections",title:"Tough Objections Deep Dive",description:"Handle the hardest objections with confidence and skill.",duration:"5 min",content:`## Tough Objections Deep Dive
Master the art of handling the most challenging objections.
### Common Tough Objections
- "I can get it cheaper online"
- "I'm not sure about this dealership"
- "I've had bad experiences before"
### The Deep Dive Approach
Listen fully, acknowledge their concern, then explore the root cause.

### Quick Quiz

**Q1:** What is the first step in the Deep Dive Approach?
...
*Answer: B) — Listening fully validates the customer and gives you the information needed to respond effectively.

**Q2:** When a customer says "I can get it cheaper online," you should:

A) Match the online price immediately
B) Acknowledge the concern and explore what else matters to them besides price
C) Tell them online dealers are scams
D) Walk away

*Answer: B) — Acknowledging the concern while redirecting to value keeps the conversation productive.

**Q3:** A customer says "I've had bad experiences before." Your best response is:

A) "That wasn't with us."
B) "I understand. Can you tell me what happened so I can make sure we do better?"
C) "That's not my problem."
D) Ignore it and continue

*Answer: B) — Empathy and a commitment to doing better builds trust that can overcome past bad experiences.

**Q4:** The Deep Dive Approach is effective because it:

A) Forces the customer to admit they're wrong
B) Addresses the root cause of the objection, not just the surface complaint
C) Makes the customer uncomfortable
D) Speeds up the sales process

*Answer: B) — Surface objections often mask deeper concerns; addressing the root is more effective than debating the surface.

**Q5:** A customer says "I had a bad experience at this dealership before." Your BEST response is:
A) "That was under previous management"
B) "I understand, and I'd like to hear what happened so I can make this experience completely different for you"
C) "All dealerships have problems sometimes"
D) Redirect to the vehicle features immediately
*Answer: B) — Owning the past and committing to a better present experience rebuilds trust authentically.`},{id:"referral-systems",title:"Referral & Repeat Business Systems",description:"Build a system that generates consistent referrals.",duration:"5 min",content:`## Referral & Repeat Business Systems
Turn every sale into a source of future business.
### The Referral System
...
**Q1:** When is the best time to ask for a referral?

A) Right after they've signed, when they're happiest
B) When they first walk in
C) After a complaint
D) During price negotiation

*Answer: A) — The emotional peak right after purchase is when customers are most likely to enthusiastically refer others.

**Q2:** How can you make it easy for customers to refer others?

A) Ask them to write a long letter
B) Provide pre-written messages or simple referral cards they can share
C) Require them to bring referrals in person
D) Charge them for the referral program

*Answer: B) — Reducing friction increases the likelihood they'll actually follow through.

**Q3:** What should you do with every referral you receive?

A) Nothing — referrals aren't valuable
B) Track them and follow up consistently
C) Call once and give up
D) Pass them to another salesperson

*Answer: B) — Consistent tracking and follow-up turns referrals into a predictable source of repeat business.

**Q4:** A repeat customer is typically:

A) Harder to sell to than a new customer
B) Easier to sell to and more profitable than a new customer
C) Not worth your time
D) Only interested in discounts

*Answer: B) — Repeat customers already trust you, making the sales process faster and more profitable.

**Q5:** What is the most effective referral incentive to offer a recent buyer?
A) A cash payment
B) A personalized follow-up with genuine appreciation and a simple way to share their experience
C) An aggressive multi-call campaign
D) A mandatory referral quota
*Answer: B) — Authentic appreciation and ease of sharing outperform transactional incentives for generating quality referrals.`}]},{id:"advanced-closing-part2",title:"Advanced Closing Strategies Part 2",subtitle:"Consultative closing techniques that close more deals",description:"Master modern consultative closing techniques for today's informed buyers. 4 lessons covering Alternative Choice Close, Assumptive Trial Close, Either/Or Objection Handling, and Micro-Agreements. 7 MCQs per lesson.",levels:"Advanced",duration:"2 hours",lessons:4,image:"closing",icon:"M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",lessonsList:[{id:"alternative-choice",title:"The Alternative Choice Close",description:"Replace yes/no questions with choice-based closes that assume the sale.",duration:"5 min",content:`## The Alternative Choice Close
...
C) now to later
D) car to truck
*Answer: B — The Alternative Choice Close reframes the decision from a yes/no question to a preference between two positive outcomes.*
...
D) Never
*Answer: B — Deploying after value is established ensures the customer understands what they are choosing between before making a selection.*
...
*Answer: B — Offering two desirable options assumes the purchase and lets the customer focus on how to buy rather than whether to buy.*
...
*Answer: B — Customers quickly detect when one option is intentionally unappealing, which erodes trust and damages credibility.*
...
D) Move to paperwork
*Answer: B — Pausing after the choice question gives the customer space to mentally commit to one of the options without pressure.*
...
*Answer: C — A sarcastic or guilt-inducing question creates pressure and damages rapport rather than guiding a collaborative decision.*
...
*Answer: B — The Alternative Choice Close is most effective when the customer already sees clear value from a thorough needs assessment.*`},{id:"assumptive-trial",title:"The Assumptive Trial Close",description:"Test commitment right after the test drive before final negotiations.",duration:"5 min",content:`## The Assumptive Trial Close
...
C) After they leave
D) During paperwork
*Answer: B — Right after the test drive is when excitement peaks, making it the ideal moment to test commitment before discussing numbers.*
...
D) Guarantees sale
*Answer: B — The Assumptive Trial Close narrows the conversation to price as the only remaining variable, streamlining the path to close.*
...
*Answer: C — Drive home today creates a vivid mental image of ownership, which is more powerful than abstract phrases about payments or fit.*
...
*Answer: C — Asking what would need to be different invites the customer to reveal the real objection rather than shutting down the conversation.*
...
*Answer: B — This close functions as a temperature check that reveals remaining objections before entering formal negotiations.*

**Q6:** Only use with buyers who already agreed?
A) True
B) False
*Answer: B — The Assumptive Trial Close works with any buyer who has completed the test drive, regardless of whether they have made prior commitments.*
...
D) Start over
*Answer: C — Once the customer confirms the vehicle is right, confidently moving to numbers maintains momentum and signals professionalism.*`},{id:"either-or-objections",title:"Either/Or Objection Handling",description:"Isolate the real objection by framing it as an either/or choice.",duration:"5 min",content:`## Either/Or Objection Handling
...
C) Confuse customer
D) End conversation
*Answer: B — Either/Or Objection Handling converts vague stall objections into specific, solvable problems you can address directly.*
...
*Answer: B — Trade-in value and payment are the two most common hidden concerns behind the I need to think about it objection.*
...
C) Sarcastic
D) Indifferent
*Answer: B — A curious and helpful tone makes the customer feel you are solving a problem together rather than pressuring them.*
...
D) Do not like you
*Answer: B — I need to think is almost always a cover for an unspoken concern the customer is not ready to articulate directly.*
...
D) Walk away
*Answer: B — Once the true objection is identified, the essential next step is offering a concrete and actionable solution.*
...
*Answer: C — A confrontational question like Why don't you just buy it creates defensiveness rather than uncovering the real objection.*
...
*Answer: A — Active listening and genuine curiosity make the Either/Or technique feel collaborative rather than interrogating.*`},{id:"micro-agreements",title:"Micro-Agreements",description:"Build toward the close with layers of small agreements throughout the sale.",duration:"5 min",content:`## Micro-Agreements
...
*Answer: B — Micro-Agreements build commitment incrementally through a series of small, easy-to-agree-to confirmations throughout the sale.*
...
*Answer: B — People have a strong psychological need to remain consistent with commitments they have already made, so each small yes builds toward the final yes.*
...
D) Sign here now
*Answer: B — Asking whether a specific feature solves their problem invites confirmation without pressure and reinforces the vehicle value.*
...
*Answer: C — Using a micro-agreement right after a customer raises a concern feels dismissive and breaks rapport instead of building it.*
...
*Answer: B — 4 to 6 micro-agreements spaced naturally throughout the sale provide enough consistency-building without feeling scripted or repetitive.*
...
C) Did you like it?
D) Are we done?
*Answer: A — A scale question gathers actionable feedback while keeping the conversation open and low-pressure.*

**Q7:** Micro-agreements eliminate need for final close?
A) True
B) False
*Answer: B — Micro-agreements build valuable momentum but do not replace the need for a clear, confident final close to seal the deal.*`}]},{id:"digital-marketing",title:"Digital Marketing for Dealers",subtitle:"Modern marketing strategies that drive traffic",description:"Learn how to use digital marketing to attract more customers to your dealership. 5-minute modules with multiple choice questions after each lesson. Covers social media, email campaigns, direct mail, and marketing analytics.",levels:"Intermediate",duration:"2.5 hours",lessons:4,image:"marketing",icon:"M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",lessonsList:[{id:"social-media",title:"Social Media for Car Dealers",description:"Use social platforms to attract and engage customers.",duration:"5 min",content:`## Social Media for Car Dealers
Social media is essential for modern dealership marketing.
### Key Platforms
- Facebook/Instagram for visual inventory
- YouTube for video walkarounds
- TikTok for short-form content`},{id:"email-marketing",title:"Email Marketing Campaigns",description:"Build and nurture leads through email.",duration:"5 min",content:`## Email Marketing Campaigns
Email remains one of the most effective marketing channels.
### Campaign Types
- New inventory alerts
- Service specials
- Seasonal promotions
- Follow-up sequences`},{id:"direct-mail",title:"Direct Mail That Works",description:"Create effective direct mail campaigns that drive results.",duration:"5 min",content:`## Direct Mail That Works
Direct mail is still highly effective for automotive.
### Best Practices
- Target the right audience
- Use compelling offers
- Track response rates
- Test and optimize`},{id:"marketing-roi",title:"Measuring Marketing ROI",description:"Track and optimize your marketing spend.",duration:"5 min",content:`## Measuring Marketing ROI
Know what's working and what's not.
### Key Metrics
- Cost per lead
- Cost per sale
- Return on ad spend
- Customer acquisition cost`}]},{id:"customer-experience",title:"Customer Experience Excellence",subtitle:"Turn every interaction into a 5-star experience",description:"Learn how to deliver exceptional customer experiences that drive satisfaction, positive reviews, and repeat business. 5-minute modules with multiple choice questions to reinforce learning.",levels:"Intermediate",duration:"2 hours",lessons:4,image:"experience",icon:"M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",lessonsList:[{id:"first-contact",title:"First Contact to First Visit",description:"Convert online inquiries into showroom visits.",duration:"5 min",content:`## First Contact to First Visit
...
- Invite them to visit`},{id:"showroom-experience",title:"The Showroom Experience",description:"Create a welcoming environment that puts customers at ease.",duration:"5 min",content:`## The Showroom Experience
A great showroom experience makes customers want to stay.
### Elements
- Clean, organized showroom
- Welcoming staff
- Refreshments available
- Low-pressure atmosphere`},{id:"online-reviews",title:"Managing Online Reviews",description:"Build a positive online reputation that attracts customers.",duration:"5 min",content:`## Managing Online Reviews
Online reviews make or break dealerships.
### Best Practices
- Ask every happy customer for a review
- Respond to all reviews (positive and negative)
- Address negative reviews professionally`},{id:"delivery-experience",title:"The Delivery Experience",description:"Make the final delivery memorable and exciting.",duration:"5 min",content:`## The Delivery Experience
The delivery is the start of the customer relationship.
### Key Elements
- Vehicle spotless and full of gas
- Walk through all features
- Take a photo together
- Set expectations for follow-up`}]},{id:"sales-drills",title:"5-Minute Sales Drills",subtitle:"Quick, focused modules for every step of the sale",description:"Bite-sized 5-minute training modules covering each step of the automotive sales process. Includes scenario-based multiple-choice questions to sharpen your skills. Perfect for daily practice.",levels:"Beginner",duration:"2 hours",lessons:10,image:"drills",icon:"M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",lessonsList:[{id:"drill-greeting",title:"Step 1: Meet & Greet (2 min)",description:"Master the 10-second first impression.",duration:"5 min",content:`## Step 1: Meet & Greet — 2 Minute Drill
**Goal:** Make a warm, professional first impression in under 10 seconds.
### Quick Quiz
...
*Answer: C — Acknowledge them, then give them space.*`},{id:"drill-qualification",title:"Step 2: Qualification (2 min)",description:"Identify what your customer truly needs.",duration:"5 min",content:`## Step 2: Qualification — 2 Minute Drill
**Goal:** Learn 3 key facts about your customer.
### Quick Quiz
**Q1:** A customer says "I'm just looking." You should:
A) Walk away
B) Say "Great! What kind of vehicle interests you?"
C) Follow them silently
*Answer: B — Keep the conversation going.*`},{id:"drill-walkaround",title:"Step 3: Walk-Around (2 min)",description:"Present vehicles that match their needs.",duration:"5 min",content:`## Step 3: Walk-Around — 2 Minute Drill
**Goal:** Match the right vehicle to the customer's needs.
### Quick Quiz
**Q1:** A customer wants a vehicle for a growing family. Focus on:
A) Horsepower
B) Safety features, cargo space, rear comfort
C) Color options
*Answer: B — Match features to their stated needs.*`},{id:"drill-testdrive",title:"Step 4: Test Drive (2 min)",description:"Turn the test drive into a sale.",duration:"5 min",content:`## Step 4: Test Drive — 2 Minute Drill
**Goal:** Let them experience the vehicle.
### Quick Quiz
**Q1:** During a test drive, you should:
A) Let them drive in silence
B) Point out features matching their needs
C) Talk about payment
*Answer: B — Connect features to their needs.*`},{id:"drill-tradein",title:"Step 5: Trade-In Appraisal (2 min)",description:"Handle trade-ins smoothly.",duration:"5 min",content:`## Step 5: Trade-In — 2 Minute Drill
**Goal:** Assess trade-in value transparently.
### Quick Quiz
**Q1:** When should you ask about a trade-in?
A) At the very end
B) Early in the process
C) After the test drive
*Answer: B — Ask early to factor it into the deal.*`},{id:"drill-numbers",title:"Step 6: The Numbers (2 min)",description:"Present pricing clearly.",duration:"5 min",content:`## Step 6: The Numbers — 2 Minute Drill
**Goal:** Present pricing and financing clearly.
### Quick Quiz
**Q1:** Most customers care most about:
A) The total price
B) The monthly payment
C) The interest rate
*Answer: B — Focus on monthly payment.*`},{id:"drill-objections",title:"Step 7: Objections (2 min)",description:"Turn objections into opportunities.",duration:"5 min",content:`## Step 7: Objections — 2 Minute Drill
**Goal:** Handle "I need to think about it."
### Quick Quiz
**Q1:** Customer says "I need to think about it." Best response:
A) "Okay, call me when you decide"
B) "What specifically is holding you back?"
C) "We have a sale ending today"
*Answer: B — Isolate the objection.*`},{id:"drill-closing",title:"Step 8: Closing (2 min)",description:"Close with confidence.",duration:"5 min",content:`## Step 8: Closing — 2 Minute Drill
**Goal:** Ask for the sale naturally.
### Quick Quiz
**Q1:** The assumptive close works best when:
A) You've addressed all concerns
B) The customer looks unsure
C) At the beginning
*Answer: A — Use it when they're showing buying signals.*`},{id:"drill-fni",title:"Step 9: F&I Handoff (2 min)",description:"Transition smoothly to finance.",duration:"5 min",content:`## Step 9: F&I — 2 Minute Drill
**Goal:** Warm handoff to the finance team.
### Quick Quiz
**Q1:** The best way to introduce F&I is:
A) "Go see Mark in finance"
B) "This is [Name], who will take care of the paperwork and some protection options for you."
C) Leave them at the desk
*Answer: B — Warm handoff with context.*`},{id:"drill-delivery",title:"Step 10: Delivery (2 min)",description:"End the experience on a high note.",duration:"5 min",content:`## Step 10: Delivery — 2 Minute Drill
**Goal:** Deliver the vehicle and set up future business.
### Quick Quiz
**Q1:** The most important follow-up is:
A) A thank you call the next day
B) A sales pitch a week later
C) Never calling again
*Answer: A — Thank them and check in.*`}]},{id:"senior-sales",title:"Senior Sales Training",subtitle:"Advanced techniques for experienced sales professionals",description:"Take your sales skills to the next level with advanced negotiation tactics, enterprise deal strategies, team leadership principles, and complex deal structuring. Designed for experienced salespeople who want to become top performers and team leaders. PLUS subscription required.",levels:"Advanced",duration:"3 hours",lessons:5,image:"advanced",icon:"M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z",lessonsList:[{id:"senior-negotiation",title:"Advanced Negotiation Tactics",description:"Master psychological negotiation techniques used by top performers.",duration:"35 min",content:`## Advanced Negotiation Tactics
...
C) "That's impossible"
D) "OK, done"`},{id:"senior-enterprise",title:"Enterprise & Fleet Deals",description:"Structure multi-vehicle deals for business and fleet customers.",duration:"35 min",content:`## Enterprise & Fleet Deals
...
D) Give them the same price as a single vehicle`},{id:"senior-leadership",title:"Sales Team Leadership",description:"Lead, motivate, and develop other salespeople on your team.",duration:"35 min",content:`## Sales Team Leadership
...
D) Assign them to another team`},{id:"senior-coaching",title:"Coaching Other Salespeople",description:"Effective one-on-one coaching techniques for automotive sales.",duration:"35 min",content:`## Coaching Other Salespeople
...
D) Take over when objections arise`},{id:"senior-complex-deals",title:"Complex Deal Structuring",description:"Navigate multi-party, high-value, and time-sensitive deals.",duration:"35 min",content:`## Complex Deal Structuring
...
D) Say you can't help them`}]},{id:"closing-objections",title:"Closing & Overcoming Objections",subtitle:"Turn every objection into an opportunity to close",description:"Master the art of handling objections and closing deals with confidence. Learn to overcome price objections, hesitation, spouse objections, competitor comparisons, and timing issues. 25 scenario-based questions to sharpen your skills.",levels:"Intermediate",duration:"4 hours",lessons:5,image:"closing",icon:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",lessonsList:[{id:"closing-price-objections",title:"Overcoming Price Objections",description:`Handle "it's too expensive" with proven techniques.`,duration:"35 min",content:`## Overcoming Price Objections
...
B) "No"
C) "OK, here's $500 off"
D) "Let me get my manager"`},{id:"closing-think-about-it",title:'Handling "I Need to Think About It"',description:"Turn hesitation into commitment with the right questions.",duration:"35 min",content:`## Handling "I Need to Think About It"
...
D) Send them home with a brochure`},{id:"closing-spouse-objections",title:"Spouse & Partner Objections",description:"Navigate dual-decision scenarios with finesse.",duration:"35 min",content:`## Spouse & Partner Objections
...
D) Offer a lease instead`},{id:"closing-competitor",title:"Competitor Comparisons",description:"Win deals when customers are cross-shopping other brands.",duration:"35 min",content:`## Competitor Comparisons
...
D) "Did you buy it?"`},{id:"closing-timing",title:"Timing & Urgency Objections",description:"Create ethical urgency and handle timing-based stalls.",duration:"35 min",content:`## Timing & Urgency Objections
...
D) Ignore the calendar entirely`}]},{id:"needs-assessment-2",title:"Landing on the Right Vehicle — Needs Assessment Part 2",subtitle:"Advanced qualification techniques to match customers with their perfect vehicle",description:"Go deeper than basic needs assessment. Learn to read buying signals, match lifestyle to vehicle, navigate family vs individual needs, qualify budgets with tact, and handle trade-in psychology. 25 in-depth scenario questions.",levels:"Intermediate",duration:"4 hours",lessons:5,image:"needs",icon:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",lessonsList:[{id:"needs2-buying-signals",title:"Reading Buying Signals",description:"Recognize verbal and non-verbal cues that indicate readiness to buy.",duration:"35 min",content:`## Reading Buying Signals
...
D) They're comparing to competitors`},{id:"needs2-lifestyle-matching",title:"Matching Lifestyle to Vehicle",description:"Connect vehicle features to the customer's daily life and passions.",duration:"35 min",content:`## Matching Lifestyle to Vehicle
...
C) Give up
D) Pick a vehicle for them randomly`},{id:"needs2-family-needs",title:"Family Needs vs. Individual Needs",description:"Balance multiple priorities when a vehicle serves the whole family.",duration:"35 min",content:`## Family Needs vs. Individual Needs
...
D) Tell them to come back without the family`},{id:"needs2-budget-qualification",title:"Budget Qualification Techniques",description:"Discuss money comfortably and qualify budgets with tact.",duration:"35 min",content:`## Budget Qualification Techniques
...
D) Guess their budget`},{id:"needs2-tradein-psychology",title:"Trade-In Psychology",description:"Understand the emotional attachment to trade-ins and use it to build trust.",duration:"35 min",content:`## Trade-In Psychology
...
C) Never
D) After they've signed`}]}];export{e as c};
