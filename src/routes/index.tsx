...
function Navbar({ t }: { t: (k: string) => string }) {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-transparent">
      <div className="mx-auto flex h-[254px] max-w-7xl items-center justify-between px-3 md:px-6">
        <a href="/" className="flex items-center shrink-0 pl-0">
          <img src="/fb-logo.png" alt="Champion Sales Training & Events" className="h-[219px] w-auto object-contain" />
        </a>
        <button
